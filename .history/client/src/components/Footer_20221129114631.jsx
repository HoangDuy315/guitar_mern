  ...
  return (
    <footer class="text-center text-lg-start bg-dark text-muted">
        ...
        <div class="container text-center text-md-start mt-4">
          <div class="row mt-2">
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4 ">
              ...
              <p>
                <a href="/about" class="text-secondary">
                  Introduction
                </a>
              </p>
              <p>
                <a
                  href="https://vietthuong.vn/chi-nhanh"
              ...
              <p>
                <a
                  href="/https://vietthuong.vn/mua-tra-gop"
                  class="text-secondary"
                >
                  Hire-Purchase
                </a>
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mb-3">
              <h6 class="text-uppercase fw-bold mb-4">General Guidance</h6>
              <p>
                <a
                  href="https://vietthuong.vn/chinh-sach-doi-tra"
                  class="text-secondary"
                >
                  Delivery - Exchange
                </a>
              ...
              <p>
                <a
                  href="https://vietthuong.vn/huong-dan-mua-hang"
                  class="text-secondary"
                >
                  Shopping guide
                </a>
              ...
              <p>
                <a
                  href="https://vietthuong.vn/chinh-sach-thanh-toan-va-bao-mat"
                  class="text-secondary"
                >
              ...
              <p>
                <a
                  href="https://vietthuong.vn/chinh-sach-bao-hanh.html"
                  class="text-secondary"
                >
                  Guitar warranty
                </a>
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
              ...
              <p>
                <a href="tel:18006715" class="text-secondary">
                  Call: <span className="text-danger">1800 6789 </span>
                </a>
              </p>
              <p>
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-2 mb-md-0 mb-3">
              ...
              <p>
                <i class="fa fa-home me-3 text-secondary"></i>6** ****, P.26,
                Q.BT, TP.HCM
              </p>
              <p>
            ...
            <div class="d-flex justify-content-center justify-content-lg-between p-4 ">
              ...
              <a
                href="http://online.gov.vn/Home/WebDetails/29527"
                className="ms-0 "
              >
                <img
                  src={CN}
              ...
              <a
                className=""
                href="https://www.dmca.com/Protection/Status.aspx?ID=eef1ddde-2dff-4626-ac14-95eda3e1eddd&refurl=https://vietthuong.vn/dan-guitar.html"
              >
                <img
                  src={DMCA}
                  alt=" "
      ...
      <div class="text-center p-2">
        © 2022 Design by:
        <a
          class="navbar-brand text-reset fw-bold"
          href="https://www.facebook.com/profile.php?id=100007746304417"
        >
          {" "}
          GNAHYUD
